...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/Buxiulei/h-ui/main/h-ui-server.sh)
```
...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/Buxiulei/h-ui/main/h-ui-client.sh)
```
