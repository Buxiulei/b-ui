...
- **从 v3 升级**: 菜单第 7 项导入 `/opt/hysteria-client/` 的节点，并停用 v3 的 `hysteria-client / xray-client / bui-tun` 单元
...
客户端：bui-c update                # 每日 timer 自动，菜单第 9 项可关
